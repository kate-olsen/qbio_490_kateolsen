...
#Writing to csvs for convenience
```{r}
...
write.csv(rna_counts,"/home1/kyolsen/490_cluster/analysis_data/skcm_rna_count_data.csv")
...
```{r}
rna_clinical <- read.csv("/home1/kyolsen/490_cluster/analysis_data/skcm_rna_clinical_data.csv")
...
rna_clinical <- read.csv("/home1/kyolsen/490_cluster/analysis_data/skcm_rna_clinical_data.csv")
rna_genes <- read.csv("/home1/kyolsen/490_cluster/analysis_data/skcm_rna_gene_data.csv")
rna_counts <- read.csv("/home1/kyolsen/490_cluster/analysis_data/skcm_rna_count_data.csv", row.names = 1)
...
write.csv(results, "/home1/kyolsen/490_cluster/analysis_data/skcm_DESeq2_results.csv")
```
...
```{r}
methylation_clinical <- read.csv("/home1/kyolsen/490_cluster/analysis_data/skcm_methylation_clinical.csv")
...
```{r}
results<-read.csv("/home1/kyolsen/490_cluster/analysis_data/skcm_DESeq2_results.csv")
