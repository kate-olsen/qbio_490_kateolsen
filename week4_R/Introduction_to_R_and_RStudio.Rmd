...
```{r setup Exercise 2.3}
    ...
    knitr::opts_knit$set(root.dir = normalizePath("/Users/olsen/Desktop/QBio490/qbio_490_kateolsen")) 
```
...
```{r Exercise 3.4}
## add code here!
name <- "Kate" #string/character
age <- 20 #double
birthday <- "01/20/2004" #string/character

v <- c(name, age, birthday)
print(v)
typeof(name)
typeof(age)
typeof(birthday)
...
if (7.5 %in% new_list) { #evaluates to FALSE
  print("A")
  if (!7.5 %in% new_list) {
    print ("B")
  }
} else if  (!(232 %in% new_list)) { #FALSE
  print("C")
} else if ("starbucks" %in% new_list &! 9 > 10) { #TRUE, output "D" and "E"
  print("D")
  if (100 < 1 | "elephant" %in% new_list) {
    print("E")
  }
  else if ("magenta" %in% new_list) { #never reached
    print("F")
  }
} else {
  print("G")
