...
write.csv(rna_clinical, "/home1/kyolsen/490_cluster/analysis_data/brca_rna_clinical_data.csv", row.names = FALSE)

# Confirm the file has been saved
cat("rna_clinical has been saved to: /home1/kyolsen/490_cluster/analysis_data/brca_rna_clinical_data.csv")
```
...
```{r Exercise 6.2}
write.csv(rna_genes, "/home1/kyolsen/490_cluster/analysis_data/brca_rna_gene_data.csv", row.names = FALSE)
```
...
```{r Exercise 6.3}
write.csv(rna_counts, "/home1/kyolsen/490_cluster/analysis_data/brca_rna_count_data.csv", row.names = TRUE)
```
